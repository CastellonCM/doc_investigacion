...
\section{Chubascos atmosféricos}
	...
	\begin{align}
	E_0 &= \xi ^e_c N_{\text{max}}, \\
	X^{\gamma}_{\text{max}} &= n_c \lambda \ln 2 = \lambda \ln[E_0/\xi ^e_c] \label{maxgamma},
	\end{align}
	donde $n_c$ es el número de longitudes $d$ necesarias para que la energía por partícula se reduzca a $\xi_c^e$, donde $N = N_{\text{max}}= 2^{n_c}$.
	\begin{wrapfigure}{r}{0.3\textwidth}
	...
	\begin{align}
	E_0 = g \xi_c^e \qty(N_e + \frac{\xi_c^{\pi}}{g \xi_c^e} N_{\mu}),
	\end{align}
	...
	\end{align}
	El segundo término corresponde a la profundidad del máximo de la componente electromagnética de la ecuación (\ref{maxgamma}), cuya energía inicial es $E_0/3N_{\pi^{\pm}}$. En general los valores calculados con la ecuación anterior son bastante bajos comparados con resultados de simulaciones; esto debido a que sólo se toma en cuenta la primera generación de partículas de la componente electromagnética. \\
